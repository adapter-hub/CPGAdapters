...
def siqa_convert_examples_to_features(
    ...
    """
    return _siqa_convert_examples_to_features(
        examples, tokenizer, max_length=max_length, task=task, label_list=label_list, output_mode=output_mode,
        max_label_length=max_label_length
    )


def _siqa_convert_examples_to_features(
...
class SIQAProcessor(DataProcessor):
    ...
    def get_train_examples(self):
        """See base class."""
        return self._create_examples(load_dataset('socialiqa', split='train'), 'train')

    def get_dev_examples(self):
        """See base class."""
        return self._create_examples(load_dataset('socialiqa', split='validation'), 'dev')

    def get_test_examples(self):
        """See base class."""
        return self._create_examples(load_dataset('socialiqa', split='test'), 'test')
